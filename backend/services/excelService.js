...
class ExcelService {
    constructor() {
        ...
        // Deployment verification - DEPLOYED VERSION 2025-09-15-v10-MANUAL-FORMATTING
        console.log('🚀 ExcelService initialized - Version 2025-09-15-v10 - Comment formatting disabled for manual handling');
    ...
    async addRowToTable(tableName, values) {
        try {
            ...
            // Comment formatting disabled - handled manually
            console.log(`ℹ️ Comment formatting disabled - will be handled manually`);
    ...
    // Comment formatting methods removed - handled manually
